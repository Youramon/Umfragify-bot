...
const x = {
  ...
  Replace: "replace",
  Add: "add"
}, An = /* @__PURE__ */ Symbol.for("__MUTATIVE_PROXY_DRAFT__"), gr = /* @__PURE__ */ Symbol("__MUTATIVE_RAW_RETURN_SYMBOL__"), ze = Symbol.iterator, ee = {
  mutable: "mutable",
  immutable: "immutable"
}, Et = {};
function je(n, e) {
...
function I(n) {
  return typeof n != "object" ? null : n?.[An];
}
function jt(n) {
  var e;
  const t = I(n);
...
function ie(n, e) {
  if (!n || typeof n != "object")
    return !1;
  let t;
  return Object.getPrototypeOf(n) === Object.prototype || Array.isArray(n) || n instanceof Map || n instanceof Set || !!e?.mark && ((t = e.mark(n, ee)) === ee.immutable || typeof t == "function");
}
function kn(n, e = []) {
  if (Object.hasOwnProperty.call(n, "key")) {
    const t = n.parent.copy, r = I(de(t, n.key));
    if (r !== null && r?.original !== n.original)
      return null;
    const s = n.parent.type === 3, i = s ? Array.from(n.parent.setMap.keys()).indexOf(n.key) : n.key;
    if (!(s && t.size > i || je(t, i)))
      return null;
    e.push(i);
  }
  if (n.parent)
    return kn(n.parent, e);
  e.reverse();
  try {
    mr(n.copy, e);
  } catch {
...
function de(n, e) {
  return be(n) === 2 ? n.get(e) : n[e];
}
function Re(n, e, t) {
  be(n) === 2 ? n.set(e, t) : n[e] = t;
}
function rt(n, e) {
  const t = I(n);
  return (t ? X(t) : n)[e];
...
function mr(n, e) {
  for (let t = 0; t < e.length - 1; t += 1) {
    const r = e[t];
    if (n = de(be(n) === 3 ? Array.from(n) : n, r), typeof n != "object")
...
const _r = Object.prototype.propertyIsEnumerable;
function On(n, e) {
  let t;
  if (Array.isArray(n))
  ...
  if (n instanceof Set) {
    ...
    return new Map(n);
  } else if (e?.mark && (t = e.mark(n, ee), t !== void 0) && t !== ee.mutable) {
    if (t === ee.immutable)
      return wr(n);
...
function V(n) {
  n.copy || (n.copy = On(n.original, n.options));
}
function Ce(n) {
  if (!ie(n))
    return jt(n);
...
function ce(n) {
  var e;
  n.assignedMap = (e = n.assignedMap) !== null && e !== void 0 ? e : /* @__PURE__ */ new Map(), n.operated || (n.operated = !0, n.parent && ce(n.parent));
}
function zt() {
  throw new Error("Cannot modify frozen object");
}
function _e(n, e, t, r, s) {
  {
  ...
  switch (be(n)) {
    case 2:
      for (const [a, c] of n)
        _e(a, a, t, r, s), _e(c, a, t, r, s);
      n.set = n.clear = n.delete = zt;
      break;
    case 3:
      for (const a of n)
        _e(a, a, t, r, s);
      n.add = n.clear = n.delete = zt;
      break;
    case 1:
      Object.freeze(n);
      let o = 0;
...
function In(n, e, t) {
  if (ye(n) || !ie(n, t) || e.has(n) || Object.isFrozen(n))
    return;
...
function Sr(n, e) {
  ...
  n.finalities.revoke.length > 1 && n.assignedMap.get(e) && t && In(de(t, e), n.finalities.handledSet, n.options);
}
function ft(n) {
...
function xt(n, e, t, r) {
  ...
  s && (s.callbacks || (s.callbacks = []), s.callbacks.push((i, o) => {
    ...
    if (le(de(c, e), t)) {
      let u = s.original;
      s.copy && (u = s.copy), ft(n), ht(n, r, i, o), n.options.enableAutoFreeze && (n.options.updatedValues = (a = n.options.updatedValues) !== null && a !== void 0 ? a : /* @__PURE__ */ new WeakMap(), n.options.updatedValues.set(u, s.original)), Re(c, e, u);
    }
  }), n.options.enableAutoFreeze && s.finalities !== n.finalities && (n.options.enableAutoFreeze = !1)), ie(t, n.options) && n.finalities.draft.push(() => {
...
function Tr(n, e, t, r, s) {
  ...
  if (i.length < c.length) {
    ...
    if (u) {
      const l = e.concat(["length"]), f = pe(l, s);
      r.push({
        op: x.Replace,
        path: f,
        value: i.length
...
function vr({ original: n, copy: e, assignedMap: t }, r, s, i, o) {
  t.forEach((a, c) => {
    const u = de(n, c), l = We(de(e, c)), f = a ? je(n, c) ? x.Replace : x.Add : x.Remove;
    if (le(u, l) && f === x.Replace)
      return;
    const d = r.concat(c), h = pe(d, o);
    s.push(f === x.Remove ? { op: f, path: h } : { op: f, path: h, value: l }), i.push(f === x.Add ? { op: x.Remove, path: h } : f === x.Remove ? { op: x.Add, path: h, value: u } : { op: x.Replace, path: h, value: u });
  });
}
function Ar({ original: n, copy: e }, t, r, s, i) {
  let o = 0;
  n.forEach((a) => {
    if (!e.has(a)) {
      const c = t.concat([o]), u = pe(c, i);
      r.push({
        op: x.Remove,
        path: u,
        value: a
...
const Be = (n, e, t = !1) => {
  if (typeof n == "object" && n !== null && (!ie(n, e) || t))
  ...
  has(n) {
    return X(I(this)).has(n);
  },
  set(n, e) {
    const t = I(this), r = X(t);
    return (!r.has(n) || !le(r.get(n), e)) && (V(t), ce(t), t.assignedMap.set(n, !0), t.copy.set(n, e), xt(t, n, e, xe)), this;
  },
  delete(n) {
    if (!this.has(n))
      return !1;
    const e = I(this);
    return V(e), ce(e), e.original.has(n) ? e.assignedMap.set(n, !1) : e.assignedMap.delete(n), e.copy.delete(n), !0;
  },
  clear() {
    const n = I(this);
    if (this.size) {
      V(n), ce(n), n.assignedMap = /* @__PURE__ */ new Map();
  ...
  get(n) {
    var e, t;
    const r = I(this), s = X(r).get(n), i = ((t = (e = r.options).mark) === null || t === void 0 ? void 0 : t.call(e, s, ee)) === ee.mutable;
    if (r.options.strict && Be(s, r.options, i), i || r.finalized || !ie(s, r.options) || s !== r.original.get(n))
      return s;
    const o = Et.createDraft({
      original: s,
      parentDraft: r,
      key: n,
    ...
    return V(r), r.copy.set(n, o), o;
  },
  keys() {
    return X(I(this)).keys();
  },
  values() {
    const n = this.keys();
    return {
...
}, kr = Reflect.ownKeys(pt), Wt = (n, e, { isValuesIterator: t }) => () => {
  var r, s;
  const i = e.next();
  if (i.done)
    return i;
  ...
  const c = I(a), u = ((s = (r = n.options).mark) === null || s === void 0 ? void 0 : s.call(r, a, ee)) === ee.mutable;
  if (n.options.strict && Be(o, n.options, u), !u && !c && ie(o, n.options) && !n.finalized && n.original.has(o)) {
    const l = Et.createDraft({
      original: o,
      parentDraft: n,
      key: o,
  ...
  add(n) {
    const e = I(this);
    return this.has(n) || (V(e), ce(e), e.assignedMap.set(n, !0), e.setMap.set(n, n), xt(e, n, n, xe)), this;
  },
  delete(n) {
    if (!this.has(n))
      return !1;
  ...
  values() {
    ...
    return {
      ...
      next: Wt(n, e, { isValuesIterator: !0 })
    };
  },
  entries() {
    const n = I(this);
...
const Or = Reflect.ownKeys(Ge), Cn = /* @__PURE__ */ new WeakSet(), En = {
  get(n, e, t) {
    var r, s;
    ...
    if (n.options.mark) {
      ...
      if (o = n.options.mark(u, ee), o === ee.mutable)
        return n.options.strict && Be(u, n.options, !0), u;
    }
    const a = X(n);
    if (a instanceof Map && kr.includes(e)) {
      if (e === "size")
        return Object.getOwnPropertyDescriptor(pt, "size").get.call(n.proxy);
      const u = pt[e];
      if (u)
    ...
    const c = a[e];
    if (n.options.strict && Be(c, n.options), n.finalized || !ie(c, n.options))
      return c;
    if (c === rt(n.original, e)) {
      if (V(n), n.copy[e] = Rt({
  ...
  set(n, e, t) {
    ...
    const o = rt(X(n), e), a = I(o);
    return a && le(a.original, t) ? (n.copy[e] = t, n.assignedMap = (r = n.assignedMap) !== null && r !== void 0 ? r : /* @__PURE__ */ new Map(), n.assignedMap.set(e, !1), !0) : (le(t, o) && (t !== void 0 || je(n.original, e)) || (V(n), ce(n), je(n.original, e) && le(t, n.original[e]) ? n.assignedMap.delete(e) : n.assignedMap.set(e, !0), n.copy[e] = t, xt(n, e, t, xe)), !0);
  },
  has(n, e) {
    return e in X(n);
  },
  ownKeys(n) {
    return Reflect.ownKeys(X(n));
  },
  getOwnPropertyDescriptor(n, e) {
    const t = X(n), r = Reflect.getOwnPropertyDescriptor(t, e);
    return r && {
      writable: !0,
  ...
  deleteProperty(n, e) {
    var t;
    return n.type === 1 ? En.set.call(this, n, e, void 0, n.proxy) : (rt(n.original, e) !== void 0 || e in n.original ? (V(n), ce(n), n.assignedMap.set(e, !1)) : (n.assignedMap = (t = n.assignedMap) !== null && t !== void 0 ? t : /* @__PURE__ */ new Map(), n.assignedMap.delete(e)), n.copy && delete n.copy[e], !0);
  }
};
function Rt(n) {
  const { original: e, parentDraft: t, key: r, finalities: s, options: i } = n, o = be(e), a = {
    type: o,
    finalized: !1,
    parent: t,
    original: e,
  ...
  (r || "key" in n) && (a.key = r);
  const { proxy: c, revoke: u } = Proxy.revocable(o === 1 ? Object.assign([], a) : a, En);
  if (s.revoke.push(u), Cn.add(c), a.proxy = c, t) {
    const l = t;
    l.finalities.draft.push((f, d) => {
      var h, p;
      const m = I(c);
      let b = l.type === 3 ? l.setMap : l.copy;
      const y = de(b, r), g = I(y);
      if (g) {
        let A = g.original;
        g.operated && (A = jt(y)), ft(g), ht(g, xe, f, d), l.options.enableAutoFreeze && (l.options.updatedValues = (h = l.options.updatedValues) !== null && h !== void 0 ? h : /* @__PURE__ */ new WeakMap(), l.options.updatedValues.set(A, g.original)), Re(b, r, A);
      }
      (p = m.callbacks) === null || p === void 0 || p.forEach((A) => {
        A(f, d);
      });
    });
  } else {
...
function Ir(n, e, t, r, s) {
  var i;
  const o = I(n), a = (i = o?.original) !== null && i !== void 0 ? i : n, c = !!e.length;
  if (o?.operated)
    for (; o.finalities.draft.length > 0; )
      o.finalities.draft.pop()(t, r);
  const u = c ? e[0] : o ? o.operated ? o.copy : o.original : n;
  return o && dt(o), s && _e(u, u, o?.options.updatedValues), [
    u,
...
function Cr(n, e) {
  ...
  let s, i;
  e.enablePatches && (s = [], i = []);
  const a = ((t = e.mark) === null || t === void 0 ? void 0 : t.call(e, n, ee)) === ee.mutable || !ie(n, e) ? n : Rt({
    original: n,
    parentDraft: null,
    finalities: r,
    options: e
  ...
  return [
    a,
    (c = []) => {
      const [u, l, f] = Ir(a, c, s, i, e.enableAutoFreeze);
  ...
  $t(t, (i, o, a) => {
    ...
    if (c && e && c.finalities === e.finalities) {
      ...
      if (a instanceof Set) {
        ...
        Re(a, i, u);
    } else typeof o == "object" && o !== null && (n.value = o, n.isRoot = !1, yt(n));
...
function Mn(n) {
  ...
  let s;
  function i() {
    s = r === 2 ? Pt(n) ? new Map(n) : new (Object.getPrototypeOf(n)).constructor(n) : r === 3 ? Array.from(t.setMap.values()) : On(n, t?.options);
  }
  if (t) {
    t.finalized = !0;
    try {
    ...
    s = n;
  if ($t(s, (o, a) => {
    if (t && le(de(t.original, o), a))
      return;
    const c = Mn(a);
    c !== a && (s === n && i(), Re(s, o, c));
  }), r === 3) {
    const o = (e = t?.original) !== null && e !== void 0 ? e : s;
    return Mt(o) ? new Set(s) : new (Object.getPrototypeOf(o)).constructor(s);
  }
  return s;
}
function Vt(n) {
...
const Er = (n) => function e(t, r, s) {
  var i, o, a;
  if (typeof t == "function" && typeof r != "function")
    return function(k, ...F) {
      return e(k, (C) => t.call(this, C, ...F), r);
    };
  const c = t, u = r;
  let l = s;
  ...
  const f = ye(c) ? Vt(c) : c, d = Array.isArray(l.mark) ? ((k, F) => {
    for (const C of l.mark) {
  ...
  if (!ie(f, b) && typeof f == "object" && f !== null)
  ...
  const R = (k) => {
    const F = I(y);
    if (!ye(k)) {
      if (k !== void 0 && !le(k, y) && F?.operated)
        throw new Error("Either the value is returned as a new non-draft value, or only the draft is modified without returning any value.");
      const O = k?.[gr];
      if (O) {
        const z = O[0];
        return b.strict && typeof k == "object" && k !== null && yt({
          rootDraft: F,
          value: k,
          useRawReturn: !0
        }), g([z]);
      ...
      if (k !== void 0)
        return typeof k == "object" && k !== null && yt({ rootDraft: F, value: k }), g([k]);
    }
    if (k === y || k === void 0)
      return g([]);
    const C = I(k);
  ...
  return A instanceof Promise ? A.then(R, (k) => {
    throw dt(I(y)), k;
  }) : R(A);
}, He = Er();
...
function Ve(n, e) {
  return typeof n != "object" || typeof e != "object" || n === null || e === null ? n === e : Pn(n, e) ? Object.keys(n).every(
    (t) => Ve(n[t], e[t])
  ) : !1;
}
function Dt(n) {
...
function jn(n, e) {
  ...
  for (const r of Object.keys(e)) {
    ...
    const s = Ee(n[r]) && Ee(e[r]);
    t[r] = s ? jn(n[r], e[r]) : e[r];
  }
  return t;
}
function Ee(n) {
...
function $n(n, e) {
  ...
  if (t in n) {
    ...
    $n(n[t], r), Pr(n[t]) && delete n[t];
  }
}
function Pr(n) {
  return n && Object.keys(n).length === 0;
}
const Gt = /ZULU|YEKT|YEKST|YAPT|YAKT|YAKST|XJT|WGT|WGST|WFT|WETDST|WET|WDT|WAT|WAST|WAKT|WADT|VUT|VOLT|VLAT|VLAST|VET|UZT|UZST|UYT|UYST|UTC|UT|ULAT|ULAST|UCT|TVT|TRUT|TOT|TMT|TKT|TJT|TFT|TAHT|SGT|SCT|SAST|SADT|RET|PYT|PYST|PWT|PST|PONT|PMST|PMDT|PKT|PKST|PHT|PGT|PETT|PETST|PET|PDT|OMST|OMSST|NZT|NZST|NZDT|NUT|NST|NPT|NOVT|NOVST|NFT|NDT|MYT|MVT|MUT|MUST|MST|MSK|MSD|MPT|MMT|MHT|MEZ|METDST|MET|MESZ|MEST|MDT|MAWT|MART|MAGT|MAGST|LKT|LINT|LIGT|LHST|LHDT|KST|KRAT|KRAST|KOST|KGT|KGST|KDT|JST|JAYT|IST|IRT|IRKT|IRKST|IOT|IDT|ICT|HST|HKT|GYT|GMT|GILT|GFT|GET|GEST|GAMT|GALT|FNT|FNST|FKT|FKST|FJT|FJST|FET|EST|EGT|EGST|EETDST|EET|EEST|EDT|EAT|EAST|EASST|DDUT|DAVT|CXT|CST|COT|CLT|CLST|CKT|CHUT|CHAST|CHADT|CETDST|CET|CEST|CDT|CCT|CAST|CADT|BTT|BST|BRT|BRST|BRA|BOT|BORT|BNT|BDT|BDST|AZT|AZST|AZOT|AZOST|AWST|AWSST|AST|ART|ARST|ANAT|ANAST|AMT|AMST|ALMT|ALMST|AKST|AKDT|AFT|AEST|AESST|AEDT|ADT|ACWST|ACT|ACST|ACSST|ACDT$/, jr = {
  ZULU: 0,
  YEKT: 18e3,
  YEKST: 21600,
  YAPT: 36e3,
...
function Vr(n) {
  ...
  if (!e)
    return null;
  const [t] = e, r = jr[t], s = new Date(n.replace(Gt, "Z"));
...
function Gr(n) {
  try {
    ...
    return typeof e == "string" ? bt(e) : null;
  } catch {
    return null;
  }
}
...
function xn(n, e, t) {
  ...
  for (const o of e) {
    ...
    l["checked-data-type"] === "date" && t && (u = Ze(u), o[2] = u), Ut(l) && H(i, [u, c, a], o), H(r, [a, c, u], o), H(s, [c, a, u], o);
  }
...
function Ln(n, e, t) {
  ...
  a && (se(n.eav, [s, i, o]), se(n.aev, [i, s, o]), Ut(a) && se(n.vae, [o, i, s]));
}
let Yr = 0;
function Fn(n, e, t) {
  const [r, s, i] = t;
  ...
  return a && (o = a[3]), o || Date.now() * 10 + Yr++;
}
function Nn(n, e, t) {
  const r = De(n, t);
  if (!r)
  ...
  if (!a)
    return;
  a["checked-data-type"] === "date" && n.useDateObjects && (o = Ze(o));
  const u = Oe(n.eav, [s, i, o])?.[3] ?? Fn(n, a, r), l = [s, i, o, u];
  Hr(a) ? (H(n.eav, [s, i], /* @__PURE__ */ new Map([[o, l]])), H(n.aev, [i, s], /* @__PURE__ */ new Map([[o, l]]))) : (H(n.eav, [s, i, o], l), H(n.aev, [i, s, o], l)), Ut(a) && H(n.vae, [o, i, s], l);
}
function Zr(n, e, t) {
  const r = De(n, t);
  if (!r)
  ...
  const c = Oe(n.eav, [s, i]);
  if (!c) return;
  const u = c.values().next()?.value;
  if (!u) return;
  const l = u[2], f = jn(l, o), d = [
    s,
    i,
    f,
    Fn(n, a, u)
...
function gt(n, e, t) {
  ...
  if (a) {
    for (const u of a.keys()) {
      ...
      l && l["on-delete-reverse"] === "cascade" && J(a.get(u), 1).forEach(
        ([f, d, h]) => gt(n, e, [h, l["reverse-identity"]?.[1]])
  ...
  c && c.forEach((u) => {
    ...
    (!s || !h || h["reverse-identity"]?.[1] === s) && (se(n.eav, [l, f, d]), se(n.aev, [f, l, d]), se(n.vae, [d, f, l])), h && h["on-delete"] === "cascade" && h["reverse-identity"]?.[1] === s && gt(n, e, [l, h["forward-identity"]?.[1]]);
...
function es(n, e, [t]) {
  ...
  const r = qn(n).filter(([s, i]) => i !== t);
  e.deleteAttr(t), Kn(n, e, r);
}
function ts(n, e, [t]) {
  e.getAttr(t.id) && (e.updateAttr(t), Kn(n, e, qn(n)));
}
function ns(n, e, t) {
  const [r, ...s] = t;
  switch (r) {
...
function ds(n) {
  return typeof n === "string" && n.startsWith("?") ? ls : Ht;
}
const fs = [
  "in",
  "$in",
...
function Wn(n, e, t) {
  return t ? typeof n == "object" ? hs(n) ? t : null : ds(n)(n, e, t) : null;
}
function ps(n, e, t) {
...
function ys(n, e, t) {
  return ms(n, e, t).map((r) => ps(e, r, t)).filter((r) => r);
}
function bs(n, e, t) {
  return e.or ? e.or.patterns.flatMap((r) => mt(n, r, t)) : e.and ? e.and.patterns.reduce((r, s) => mt(n, s, r), t) : t.flatMap((r) => ys(n, e, r));
}
function mt(n, e, t = [{}]) {
  return e.reduce((r, s) => bs(n, s, r), t);
}
function Ft(n, e) {
  return Array.isArray(e) ? e.map((t) => Ft(n, t)) : us(e) ? n[e] : e;
}
function gs(n, { find: e, where: t }) {
  return mt(n, t).map((s) => Ft(s, e));
}
function ms(n, e, t) {
  return ss(n, Ft(t, e));
}
...
function Ae(n) {
  return typeof n == "string" && ws.test(n);
}
const K = [];
for (let n = 0; n < 256; ++n)
...
const vs = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Jt = { randomUUID: vs };
function As(n, e, t) {
  if (Jt.randomUUID && !n)
    return Jt.randomUUID();
  n = n || {};
  const r = n.random ?? n.rng?.() ?? Ts();
  if (r.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, _s(r);
}
function Yt(n) {
...
function wt(n, e, t, r, s, i) {
  const o = s.slice(0, s.length - 1), a = s[s.length - 1], [c, u, l] = Ds(
    n,
    e,
    t,
    r,
...
function Bn(n, e, t, r, s) {
  return Object.entries(s).flatMap(([i, o]) => {
    if (Ls([i, o]))
      return en(n, "or", e, t, r, o);
    if (Fs([i, o]))
      return en(n, "and", e, t, r, o);
...
function qs(n, e, t, r) {
  const s = Xe;
  return r ? Bn(s, n, e, t, r).concat(Zt(s, n, e, t)) : Zt(s, n, e, t);
}
function zs(n, e, t) {
...
function Vs(n, e, t, { etype: r, level: s, form: i }, o) {
...
function Qs(n, e, t) {
  return t === "string" ? Es(n, e) : n > e ? 1 : -1;
}
function Me(n, e, t, r, s) {
  return e === r || e == null && r == null ? Os(n, t) : r == null ? 1 : e == null ? -1 : Qs(e, r, s);
}
...
function Gn(n, e, t) {
  ...
  if (e["forward-identity"]?.[2] === "id")
    return Je(t, [r, o], null);
  const [a, c] = t, u = e["checked-data-type"], l = u === "date" ? _t(c) : c, f = u === "date" ? _t(i) : i;
  return Je([a, l], [r, f], u);
}
function Bs(n, e, t, r) {
  const s = Gn(n, e, r);
...
function Xs(n, e, { etype: t, pageInfo: r, dq: s, form: i }) {
  const o = i?.$?.order, a = Hn(i), c = ei(i);
  let u = gs(n, s);
  const l = r?.["start-cursor"], f = r?.["end-cursor"], d = Ys(e, t, l, o);
  if (d && d?.["forward-identity"]?.[2] !== "id") {
    const m = d["checked-data-type"] === "date", b = d.id;
    u = u.map(([y]) => {
      let g = n.eav.get(y)?.get(b)?.values()?.next()?.value?.[2];
      return m && (g = _t(g)), [y, g];
    });
  }
  u.sort(
    c === "asc" ? function(b, y) {
      return Je(b, y, d?.["checked-data-type"]);
    } : function(b, y) {
      return Je(y, b, d?.["checked-data-type"]);
    }
  );
  let h = {};
  const p = Zs(e, t, s);
  for (const m of u) {
    const [b] = m;
    if (h[b] || !a && l && d && Bs(l, d, c, m) || !a && f && d && Gs(f, d, c, m))
      continue;
    const y = is(n, p, b);
    y && (h[b] = y);
  }
...
function ti(n, e, { etype: t, level: r, form: s, join: i, pageInfo: o }) {
  if (!Hn(s) && (!o || !o["start-cursor"]))
    return [];
  const a = Us(
    qs(e, t, r, s.$?.where),
    i
  ), c = zs(Xe, t, r), u = s.$?.fields, l = Xs(n, e, {
    etype: t,
    pageInfo: o,
    form: s,
  ...
  if (f != null) {
    ...
    return d.length <= f ? l : Object.fromEntries(d.slice(0, f));
  }
  return l;
}
function ni(n, e, t) {
...
function Nt({
  ...
  const o = { data: Object.keys(s).reduce(function(c, u) {
    return r?.[u] || u === "$$ruleParams" || (c[u] = Jn(n, e, {
      etype: u,
      form: s[u],
      level: 0,
      pageInfo: t?.[u]
  ...
  return t && (o.pageInfo = ri(t)), r && (o.aggregate = r), o;
}
function si() {
  const e = {
    __etype: 1,
...
function ai(n) {
  return new Proxy(
    ...
    },
    {
      get(e, t) {
        if (t === "lookup")
          return (s, i) => Qe(n, St(oi(s, i)), []);
        if (t === "__etype") return n;
        const r = t;
        return Ye(r) ? Qe(n, St(r), []) : Qe(n, r, []);
      }
    }
  );
}
...
function fi(n, e, t) {
  if (!di(n, e, t))
    return U(n, e, t);
  const r = Tt(t), s = U(n, e, r) || ge(n, e, r);
  if (s && s["value-type"] !== "ref")
    throw new Error(`${t} does not reference a valid link attribute.`);
  return s;
}
function vt(n) {
  return typeof n == "string" && !Ye(n) ? null : typeof n == "string" && Ye(n) ? St(n) : li(n);
}
function Y(n, e, t) {
  const r = vt(t);
  if (r === null)
    return t;
  const [s, i] = r, o = fi(n, e, s);
  if (!o || !o["unique?"])
...
function hi({ attrsStore: n }, [e, t, r]) {
  const s = Object.entries(r).flatMap(([i, o]) => {
    const a = Array.isArray(o) ? o : [o], c = U(n, e, i), u = ge(n, e, i);
    return a.map((l) => c ? [
      "add-triple",
      Y(n, e, t),
      c.id,
      ...
      // already exist
      Y(n, c["reverse-identity"][1], l)
    ] : [
      "add-triple",
      // Uses `!` because if we get here, we should have created the attr if it doesn't
      // already exist
      Y(n, u["forward-identity"][1], l),
      u?.id,
      Y(n, e, t)
    ]);
  });
...
function pi({ attrsStore: n }, [e, t, r]) {
  const s = Object.entries(r).flatMap(([i, o]) => {
    const a = Array.isArray(o) ? o : [o], c = U(n, e, i), u = ge(n, e, i);
    return a.map((l) => c ? [
      "retract-triple",
    ...
    for (const s of n || []) {
      ...
      if (i) {
        for (const o of i.keys())
          if (e.getAttr(o)?.["forward-identity"][1] == t)
            return !0;
      }
    }
  return !1;
}
function Xn({ stores: n, attrsStore: e }, [t, r, s, i]) {
  return i?.upsert === !1 ? { mode: "update" } : i?.upsert === !0 ? null : yi(n, e, t, r) ? { mode: "update" } : null;
}
function bi(n, e) {
  const { attrsStore: t } = n, [r, s, i, o] = e, a = Dt(i), c = Y(t, r, s);
  return [["id", c]].concat(Object.entries(a)).map(([l, f]) => {
    const d = U(t, r, l);
    return d["checked-data-type"] === "date" && n.useDateObjects && (f = Ze(f)), ["add-triple", c, d.id, f, { mode: "create" }];
  });
}
function gi(n, e) {
  const { attrsStore: t } = n, [r, s, i, o] = e, a = Dt(i), c = Y(t, r, s), u = Xn(n, [r, c, i, o]);
  return [["id", c]].concat(Object.entries(a)).map(([f, d]) => {
    const h = U(t, r, f);
    return h["checked-data-type"] === "date" && n.useDateObjects && (d = Ze(d)), [
      "add-triple",
      c,
      h.id,
      d,
...
function mi({ attrsStore: n }, [e, t]) {
  return [["delete-entity", Y(n, e, t), e]];
}
function wi(n, e) {
  const { attrsStore: t } = n, [r, s, i, o] = e, a = Dt(i), c = Y(t, r, s), u = Xn(n, [r, c, i, o]), l = Object.entries(a).map(([d, h]) => {
    const p = U(t, r, d);
    return [
      "deep-merge-triple",
      c,
...
function _i({ attrsStore: n }, [e, t, r]) {
...
function Ai(n, e, t) {
  ...
  const { unique: s, indexed: i } = r?.config, o = vi(r?.valueType);
  return {
    "index?": i,
    "unique?": s,
    "checked-data-type": o
...
function Fe(n, e, t, r) {
  const s = n ? Ai(n, e, t) : null, i = j(), a = [j(), e, t];
  return {
    id: i,
    "forward-identity": a,
    "value-type": "blob",
...
function nn(n, e, t, r) {
  const s = n ? Oi(n, e, t) : null, i = j(), o = [j(), e, t], a = [j(), t, e];
  return {
    id: i,
...
const Ii = /* @__PURE__ */ new Set(["create", "update", "merge", "link", "unlink"]), Ci = /* @__PURE__ */ new Set(["link", "unlink"]), Ei = /* @__PURE__ */ new Set(["create", "update", "merge"]), Mi = /* @__PURE__ */ new Set([
  "link",
  "unlink",
  "create",
  "update",
...
function $i({ attrsStore: n, schema: e }, t) {
  ...
  function f(d, h) {
    ...
    u(p), u(m), !p && !m && c(nn(e, d, h, Pi));
  }
  for (const d of t)
    for (const { etype: h, lookupPair: p, linkLabel: m } of ji(d)) {
      const b = p[0];
      if (m) {
        f(h, m);
...
function xi(n, e) {
  const r = (Array.isArray(e) ? e : [e]).flatMap((c) => ci(c)), [s, i] = $i(n, r), o = { ...n, attrsStore: s }, a = r.flatMap((c) => Ti(o, c));
  return [...i, ...a];
}
function rn(n, e) {
...
class kt {
  ...
  async _initMeta() {
    ...
    try {
      const e = this._persister.getItem(Te);
  ...
  updateInPlace(e) {
    this._version++;
    const [t, r] = He(this.currentValue, e, {
      enablePatches: !0
    });
    for (const s of r) {
      const i = s.path[0];
  ...
  async clearUnloadedKeys() {
    ...
    for (const t of await this._persister.getAllKeys())
      t === Te || t in this.currentValue || (this._pendingSaveKeys.add(t), e = !0);
    e && await this._enqueuePersist();
  }
}
const Ri = 6, Di = ["kv", "querySubs", "syncSubs"];
function Ui(n) {
  return function(t) {
...
async function Fi(n, e, t) {
  ...
  return new Promise((i, o) => {
    ...
    const c = { objects: a }, u = t.put(c, Te);
    s.add(u);
    for (const l of s)
      l.onsuccess = () => {
...
async function Ni(n, e) {
  const t = await Li(`instant_${n}_5`);
  if (!t)
    return;
...
class tr extends er {
  ...
  _dbPromise;
  constructor(e, t) {
    super(e, t), this.dbName = `instant_${e}_${Ri}`, this._storeName = t, this._appId = e, this._dbPromise = this._init();
  }
  _init() {
    return new Promise((e, t) => {
      ...
      s.onerror = (i) => {
        ...
        if (a.onclose = () => {
          ...
          const c = Ni(this._appId, a).catch((u) => {
            Ui("Error upgrading store from version 5 to 6.")(u);
          });
          on.set(this.dbName, c), c.then(() => e(a)).catch(() => e(a));
        } else {
          const c = on.get(this.dbName);
  ...
  async setItem(e, t) {
    return this._withRetry((r) => new Promise((s, i) => {
      ...
      o.objectStore(this._storeName).put(t, e), o.oncomplete = () => s(), o.onerror = () => i(o.error), o.onabort = () => i(o.error);
    }));
  }
  async multiSet(e) {
    return this._withRetry((t) => new Promise((r, s) => {
      ...
      for (const [a, c] of e)
        o.put(c, a);
      i.oncomplete = () => r(), i.onerror = () => s(i.error), i.onabort = () => s(i.error);
    }));
  }
  async removeItem(e) {
    return this._withRetry((t) => new Promise((r, s) => {
      const i = t.transaction([this._storeName], "readwrite");
      i.objectStore(this._storeName).delete(e), i.oncomplete = () => r(), i.onerror = () => s(i.error), i.onabort = () => s(i.error);
    }));
  }
  async getAllKeys() {
...
class q extends Error {
  ...
  constructor(e, t, r) {
    ...
    Object.setPrototypeOf && Object.setPrototypeOf(this, s), Error.captureStackTrace && Error.captureStackTrace(this, q), this.name = "InstantError";
  }
...
class Ue extends q {
  ...
  constructor(e) {
    ...
    Object.setPrototypeOf && Object.setPrototypeOf(this, r), Error.captureStackTrace && Error.captureStackTrace(this, Ue), this.name = "InstantAPIError", this.status = e.status, this.body = e.body;
  }
  get [Symbol.toStringTag]() {
...
async function oe(n, e) {
  ...
  return t.status === 200 ? Promise.resolve(r) : Promise.reject(new Ue({ status: t.status, body: r }));
}
function Ki({
  apiURI: n,
  appId: e,
...
let Kt = !1, rr = !1, sr = !1;
typeof window < "u" && typeof window.localStorage < "u" && (Kt = !!window.localStorage.getItem("devBackend"), rr = !!window.localStorage.getItem("__instantLogging"), sr = !!window.localStorage.getItem("__devtoolLocalDash"));
function cn(n, e) {
  if (!e) return n;
  const t = {};
  return e.forEach((r) => {
...
function Xi(n, e) {
  if (n.isLoading !== e.isLoading || n.error !== e.error || (n.user || e.user) && (!n.user || !e.user || !Qt(n.user, e.user)) || !Pn(n.peers, e.peers)) return !0;
  for (const r of Object.keys(n.peers))
    if (!Qt(n.peers[r], e.peers[r])) return !0;
  return !1;
}
class un {
  promise;
...
class et {
  ...
  asType() {
    return new et(this.attrs, this.links);
  }
}
class tt {
  constructor(e, t, r) {
...
const dn = [
  ...
  "fields",
  "aggregate"
], to = (n) => n.valueType || "unknown", ar = (n, e, t = !1) => {
  ...
  const i = to(t), o = t.valueType === "json";
  ...
  for (const o of Object.keys(n))
    if (!dn.includes(o))
      throw new P(
        `Invalid query parameter '${o}' in $ object. Valid parameters are: ${dn.join(", ")}. Found: ${o}`,
        r
      );
  const i = [
...
}, hn = (n) => typeof n != "string" ? !1 : Ye(n) ? !0 : Ae(n);
class ne extends Error {
  constructor(e) {
    super(e), this.name = "TransactionValidationError";
  }
}
const lr = (n) => n.length > 0 ? n.join(", ") : "none", io = (n, e) => new ne(
  `Entity '${n}' does not exist in schema. Available entities: ${lr(e)}`
), oo = {
  ...
  json: () => !0
}, ao = (n, e) => n == null ? !0 : oo[e.valueType]?.(n) ?? !1, dr = (n, e) => {
  const t = e.entities[n];
  if (!t)
    throw io(n, Object.keys(e.entities));
  return t;
}, it = (n, e, t) => {
  const r = dr(n, t);
  ...
  for (const [s, i] of Object.entries(e)) {
    if (!r.links[s]) {
      ...
      throw new ne(
        `Link '${s}' does not exist on entity '${n}'. Available links: ${lr(a)}`
      );
    }
    if (i != null) {
      if (Array.isArray(i)) {
...
class yn {
  ...
  onerror;
  constructor(e) {
    this.id = `${this.type}_${fr++}`, this.conn = new WebSocket(e), this.conn.onopen = (t) => {
...
class fo {
  ...
  onerror;
  constructor(e, t, r) {
    this.id = `${this.type}_${fr++}`, this.url = t, this.messageUrl = r || this.url, this.ES = e, this.conn = new e(t), this.sseInitTimeout = setTimeout(() => {
...
function ho(n, e) {
  const t = n.values;
  if (t) {
    const r = Un(t.attrsStore, null);
    if (r) {
      for (const s of t.entities || [])
        s.store.useDateObjects = e, s.store = Dn(r, s.store);
      t.attrsStore = r;
    }
  }
  return n;
...
var wo = /* @__PURE__ */ ((n) => (n.InitialSyncBatch = "InitialSyncBatch", n.InitialSyncComplete = "InitialSyncComplete", n.LoadFromStorage = "LoadFromStorage", n.SyncTransaction = "SyncTransaction", n.Error = "Error", n))(wo || {});
class _o {
  trySend;
  subs;
  ...
  constructor(e, t, r, s, i, o) {
    this.trySend = e, this.config = r, this.log = s, this.createStore = i, this.getAttrs = o, this.subs = new kt({
      persister: t,
      merge: yo,
      serialize: po,
      parse: (a, c) => ho(c, this.config.useDateObjects),
  ...
  onStartSyncOk(e) {
    const t = e["subscription-id"], r = e.q, s = L(r);
  ...
  onSyncLoadBatch(e) {
    ...
    const c = a.entities;
    for (const u of r) {
      const l = this.createStore(u), f = ot(o, l, a.attrsStore);
      c.push({
        store: l,
        entity: f,
        serverCreatedAt: bn(
    ...
    for (const o of e.txes) {
      ...
      e: for (const [m, b] of Object.entries(c))
        for (let y = 0; y < l.length; y++) {
          const g = l[y];
          if (Jr(g.store, m)) {
            gn(g.store, u.attrsStore, b);
            const A = ot(s, g.store, u.attrsStore), R = bo(
              g.store,
              u.attrsStore,
              b
            )[m];
      ...
      const p = go(s, this.getAttrs);
      mo(s, p, l), this.notifyCbs(r, {
  ...
  onStartSyncError(e) {
    const t = L(e["original-event"].q), r = {
...
function So({
  ...
  async function T() {
    ...
    switch (_.type) {
      case "ok": {
        const { streamId: v, offset: N } = _;
        o = v, w(N), g.length && r({
          streamId: v,
          chunks: g.map((G) => G.chunk),
          offset: b
        }), m = !1;
        break;
      }
  ...
  function Z(_) {
    return l ? (S(_, new q("Stream has been closed.")), null) : o || (S(_, new q("Stream has not been initialized.")), null);
  }
  async function B(_) {
    c = _;
    let v = !0, N = 0;
    for (; v; ) {
      let G = Date.now() + Math.min(15e3, 500 * (N - 1));
      v = !1;
      const re = await t({
        clientId: e.clientId,
        reconnectToken: u,
      ...
      switch (re.type) {
        case "ok": {
          const { streamId: ue, offset: nt } = re;
          if (nt !== 0) {
    ...
    async streamId() {
      return o || new Promise((v, N) => {
        const G = [], re = () => {
          ...
          N(he || new q("Stream is closed.")), re();
        };
        G.push(O(ue)), G.push(k(nt));
      });
    }
  }
  return {
    stream: new W({
      ...
      write(_, v) {
        const N = Z(v);
        if (N) {
          const G = A.encode(_).length;
          g.push({ chunk: _, byteLen: G });
          const re = b + y;
          y += G, m || r({ streamId: N, chunks: [_], offset: re });
        }
      },
      close() {
        o ? r({
...
function vo({
  ...
  async function A(C, O) {
    ...
    for await (const M of t(z)) {
      ...
      if (M.offset > s) {
        y(O, new q("Stream is corrupted.")), i = !0;
        return;
      }
      d = M.streamId;
      for (const S of f)
      ...
      if (M.files && M.files.length) {
        ...
        for (let E = 0; E < M.files.length; E++) {
          const D = M.files[E + 1], B = await T;
          if (D && (T = fetch(D.url, { signal: S.signal })), !B.ok) {
            if (g++, g > 10) {
              y(O, new q("Unable to process stream."));
              return;
            }
            return { retry: !0 };
          }
          if (B.body) {
            ...
            try {
              for (; ; ) {
                const { done: te, value: _ } = await W.read();
                if (te)
                  break;
                if (i) {
                  S.abort();
            ...
            const W = await B.arrayBuffer();
            let te = W;
            if (i) {
              S.abort();
              return;
            }
            if (w > 0 && (te = new Uint8Array(W).subarray(w), w -= W.byteLength - te.length), !te.byteLength)
              continue;
            s += te.byteLength;
            const _ = o.decode(te);
            O.enqueue(_);
  ...
  async function R(C) {
    ...
    for (; O; ) {
      O = !1;
      let M = Date.now() + Math.min(15e3, 500 * (z - 1));
      (await A(
        { ...e, offset: s },
        C
      ))?.retry && (O = !0, z++, M < Date.now() - 3e5 && (z = 0), await new Promise((S) => {
...
class Ao {
  ...
  createWriteStream(e) {
    const { stream: t, addCompleteCb: r } = So({
  ...
  createReadStream(e) {
    const { stream: t, addCloseCb: r } = vo({
  ...
  onRecieveError(e) {
    ...
    switch (t.op) {
      ...
      case "start-stream": {
        ...
        s && (s({
          type: "error",
          error: new q(e.message || "Unknown error", e.hint)
...
const ae = {
  ...
  CLOSED: "closed",
  ERRORED: "errored"
}, ko = 3e4, Oo = 3e4, Io = 200, Co = 1e3 * 60, Eo = {
  apiURI: "https://api.instantdb.com",
  websocketURI: "wss://api.instantdb.com/runtime/session"
}, at = "_instant_oauth_redirect", ct = "_instant_extra_fields_id", Ke = "oauthExtraFields", me = "currentUser";
function Mo({
  transportType: n,
  appId: e,
  apiURI: t,
...
class Uo {
  ...
  constructor(e, t = tr, r = nr, s, i) {
    if (this._EventSource = i, this.config = { ...Eo, ...e }, this.queryCacheLimit = this.config.queryCacheLimit ?? 10, this._pendingTxCleanupTimeout = this.config.pendingTxCleanupTimeout ?? Oo, this._pendingMutationCleanupThreshold = this.config.pendingMutationCleanupThreshold ?? Io, this._log = eo(
      e.verbose || Kt || rr,
      () => this._reactorStats()
    ), this.versions = { ...s || {}, "@instantdb/core": or }, this.config.schema && (this._linkIndex = Ot(this.config.schema)), !!Po()) {
      if (!e.appId)
      ...
      })), this._initStorage(t), this._syncTable = new _o(
  ...
  updateSchema(e) {
    ...
    }, this._linkIndex = e ? Ot(this.config.schema) : null;
  }
  _reactorStats() {
    return {
  ...
  _initStorage(e) {
    this.querySubs = new kt({
      persister: new e(this.config.appId, "querySubs"),
      merge: Do,
      serialize: $o,
      parse: (t, r) => jo(r, this.config.useDateObjects),
      // objectSize
    ...
    }), this.querySubs.onKeyLoaded = (t) => this._onQuerySubLoaded(t), this.kv = new kt({
  ...
  _addQueryData(e, t, r) {
    ...
    const s = L(e), i = this.ensureAttrs(), o = Se(
      this.attrs,
      t.triples,
      r,
      this.config.useDateObjects
  ...
  _handleReceive(e, t) {
    ...
    switch (mn[t.op] || this._log.info("[receive]", e, t.op, t), t.op) {
      case "init-ok": {
        this._setStatus(ae.AUTHENTICATED), this._reconnectTimeoutMs = 0, this._setAttrs(t.attrs), this._flushPendingMessages(), this._sessionId = t["session-id"];
      ...
      case "add-query-ok": {
        ...
        if (!this._hasQueryListeners() && !this.querySubs.currentValue[c])
          break;
        const u = a?.[0]?.data?.["page-info"], l = a?.[0]?.data?.aggregate, f = ln(a), d = this.ensureAttrs(), h = Se(
          d,
          f,
          r,
          this.config.useDateObjects
      ...
      case "refresh-ok": {
        ...
        const l = ut(u.entries()), f = o.map((d) => {
          const h = d["instaql-query"], p = d["instaql-result"], m = L(h), b = ln(p), y = this.ensureAttrs(), g = Se(
            y,
            b,
            r,
            this.config.useDateObjects
            ...
            l,
            c
          ), k = p?.[0]?.data?.["page-info"], F = p?.[0]?.data?.aggregate;
          return {
            q: h,
            hash: m,
            store: A,
  ...
  _handleReceiveError(e) {
    ...
    if (e["original-event"]?.hasOwnProperty("q") && e["original-event"]?.op === "add-query") {
      const a = e["original-event"]?.q, c = L(a);
      this.notifyQueryError(L(a), s), this.notifyQueryOnceError(a, c, t, s);
      return;
    }
...
`,
  ...
  subscribeQuery(e, t, r) {
    this.config.disableValidation || fn(e, this.config.schema), r && "ruleParams" in r && (e = { $$ruleParams: r.ruleParams, ...e });
  ...
  queryOnce(e, t) {
    this.config.disableValidation || fn(e, this.config.schema), t && "ruleParams" in t && (e = { $$ruleParams: t.ruleParams, ...e });
    const r = new un();
    if (!this._isOnline)
      return r.reject(
  ...
  _rewriteMutationsSorted(e, t) {
    return ut(this._rewriteMutations(e, t).entries());
  }
  // ---------------------------
  // Transact
  /**
  ...
  notifyOne = (e) => {
    ...
    s?.data && (this._dataForQueryCache[e] = s, !Ve(s.data, r) && t.forEach((i) => i.cb(s.data)));
  };
  ...
  pushTx = (e) => {
    this.config.disableValidation || lo(e, this.config.schema);
    try {
      const t = xi(
        {
  ...
  _trySend(e, t, r) {
    if (this._transport.isOpen()) {
      switch (mn[t.op] || this._log.info("[send]", this._transport.id, t.op, {
        "client-event-id": e,
        ...t
      }), t.op) {
        case "transact": {
  ...
  _replaceUrlAfterOAuth() {
    ...
    if (e.searchParams.get(at)) {
      const t = e.toString();
      e.searchParams.delete(at), e.searchParams.delete(ct), e.searchParams.delete("code"), e.searchParams.delete("error");
  ...
  async _oauthLoginInit() {
    ...
    try {
      let i;
      const o = await this.kv.waitForKeyToLoad(Ke);
      s && o && (i = o[s]), o && this.kv.updateInPlace((l) => {
        delete l[Ke];
      });
      const a = await this._getCurrentUser(), c = a?.type === "guest", { user: u } = await an({
        apiURI: this.config.apiURI,
        appId: this.config.appId,
        code: r,
  ...
  async getAuth() {
    ...
    if (t)
      throw new q("Could not get current user: " + t.message);
    return e ?? null;
  }
  ...
  async signInWithMagicCode(e) {
    const t = await this.getCurrentUser(), r = t?.user?.type === "guest", s = await qi({
      apiURI: this.config.apiURI,
      appId: this.config.appId,
      email: e.email,
      code: e.code,
  ...
  async exchangeCodeForToken({ code: e, codeVerifier: t, extraFields: r }) {
    const s = await this.getCurrentUser(), i = s?.user?.type === "guest", o = await an({
      apiURI: this.config.apiURI,
      appId: this.config.appId,
      code: e,
      codeVerifier: t,
  ...
  async signInWithIdToken(e) {
    const r = (await this.getCurrentUser())?.user?.refresh_token, s = await Vi({
      apiURI: this.config.apiURI,
      appId: this.config.appId,
      idToken: e.idToken,
  ...
  _notifyPresenceSub(e, t) {
    ...
    r && (t.prev && !Xi(r, t.prev) || (t.prev = r, t.cb(r)));
  }
  ...
  _setPresencePeers(e, t) {
    ...
    this._presence = He(this._presence, (i) => {
      Bt(i, [e, "result", "peers"], s);
    });
  }
  // --------
  // Broadcast
  ...
  // ---------------------------------
  async upload(e, t) {
    const s = (await this.getCurrentUser())?.user?.refresh_token, i = e || t.name, o = await Hi({
      apiURI: this.config.apiURI,
      appId: this.config.appId,
      fileName: i,
      refreshToken: s
...
function Bo(n, e) {
  wn?.dispose();
  const t = Xo(e), r = Jo(e, a), s = Ho(Go(n));
  function i(l) {
  ...
  function u() {
    document.body.appendChild(t.element), document.body.appendChild(r.element), addEventListener("keydown", o), addEventListener("message", i), wn = {
      dispose: c
    };
  }
  return u();
...
function Go(n) {
  return `${Kt || sr ? "http://localhost:3000" : "https://instantdb.com"}/_devtool?appId=${n}`;
}
function Ho(n) {
...
const wa = (n) => ({
  POST: async (e) => {
    ...
    try {
      ...
      return qe(400, "Invalid JSON body");
    }
    return t.type ? t.appId !== n.appId ? qe(403, "App ID mismatch") : t.type === "sync-user" ? ea(n, t.user ?? null) : qe(400, `Unknown type: ${t.type}`) : qe(400, 'Missing "type" field');
  }
}), _a = (n) => {
  const e = {};
...
class Sa {
  ...
  addQueryResult = (e, t) => {
    this.resultMap.set(e, {
      ...
      promise: null,
      error: null
    }), ta || (this.db._reactor.attrs || this.db._reactor._setAttrs(t.attrs), this.db._reactor._addQueryData(
      t.query,
      t,
  ...
  completeIsomorphic = (e, t, r, s) => {
    ...
    const o = !!this.db?._reactor?.config?.schema && ("cardinalityInference" in this.db?._reactor?.config ? !!this.db?._reactor.config?.cardinalityInference : !0), a = new fe(
      ...
      Ot(this.db?._reactor.config.schema)
    ), c = Se(
      a,
      t,
      o,
    ...
    try {
      ...
      if (!t.ok)
        try {
          ...
          throw "message" in a ? new Ue({ body: a, status: t.status }) : new Error("Error getting triples from server");
        } catch (a) {
          throw a instanceof q ? a : new Error("Error getting triples from server");
        }
...
const na = (n) => JSON.stringify(n), Pe = (n, e = !1) => JSON.stringify([n, e]), _n = (n) => {
  const [e, t] = JSON.parse(n);
  return { cursor: e, afterInclusive: t };
}, we = (n, e, t = !1) => `${n}:${Pe(e, t)}`, ra = (n) => !!n.endCursor, sa = (n) => {
...
}, pr = (n) => n && Object.keys(n).length > 0 ? n : {
  serverCreatedAt: "asc"
}, ia = (n, e) => {
  const t = [
...
}, lt = ["bootstrap", "bootstrap", "bootstrap", 1], oa = (n, e, t, r) => {
  const { entityName: s, entityQuery: i } = yr(e), o = i.$?.limit || 10, a = s, c = pr(i.$?.order), u = /* @__PURE__ */ new Map(), l = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
  let d = !1, h = !0, p = null, m = null;
  const b = (w) => {
    t({ error: w, data: void 0, canLoadNextPage: !1 });
  }, y = () => {
    if (!h) return;
    const { chunks: w, data: S } = ia(u, l);
    t({
      data: { [a]: S },
      // @ts-expect-error hidden debug variable
      chunks: w,
      canLoadNextPage: sa(u)
    });
  }, g = (w, S) => {
    u.set(Pe(w, S.afterInclusive), S), y();
  }, A = (w, S) => {
    l.set(Pe(w), S), O(), y();
  }, R = (w, S) => {
    const { cursor: T } = _n(w);
    ...
    const D = n.subscribeQuery(
      ...
      (Z) => {
        if (Z.error)
          return b(Z.error);
        const B = Z.data[a], W = Z.pageInfo[a];
        Ie(
          B && W,
    ...
    const S = n.subscribeQuery(
      ...
      (T) => {
        ...
        Ie(E && D, "Expected rows and pageInfo"), A(w, {
          data: E,
    ...
    const Z = n.subscribeQuery(
      ...
      (B) => {
        if (B.error)
          return b(B.error);
        const W = B.data[a], te = B.pageInfo[a];
        Ie(W && te, "Expected rows and pageInfo"), g(w, {
          data: W,
          status: "frozen",
    ...
    if (!w) return;
    const [S, T] = w;
    if (!T?.hasMore || !ra(T)) return;
    const E = `${S}:${na(T.endCursor)}`;
    ...
    const { cursor: E, afterInclusive: D } = _n(S);
    C(E, D), F(T.endCursor);
  };
  return m = n.subscribeQuery(
    ...
    async (w) => {
      ...
      if (Ie(T && S, "Expected rows and pageInfo"), T.length < o) {
        g(lt, {
          data: T,
      ...
      u.delete(Pe(lt)), F(E, !0), k(S.startCursor), d = !0;
    },
    r
  ), {
    unsubscribe: () => {
  ...
  const { entityName: r, entityQuery: s } = yr(e), i = s.$?.limit || 10, o = pr(s.$?.order);
  let a = e ? br({
    [r]: {
      ...s,
      $: {
...
class la {
   ...
   */
  signInAsGuest = () => this.db.signInAsGuest();
  /**
...
class ha {
  ...
  tx = Yn();
  constructor(e) {
    this._reactor = e, this.auth = new la(this._reactor), this.storage = new da(this._reactor), this.streams = new fa(this._reactor);
  }
  /**
  ...
  shutdown() {
    delete Ct[It(this._reactor.config)], this._reactor.shutdown();
  }
  /**
...
function pa(n, e) {
  return vn(n._reactor.config.schema) !== vn(e);
}
function ya(n, e, t, r, s) {
  ...
  if (o)
    return pa(o, i.schema) && o._reactor.updateSchema(i.schema), o;
  const a = new Uo(
    {
      ...aa,
      ...i,
  ...
  return Ct[It(i)] = c, ba(i.appId, i.devtool), c;
}
function ba(n, e) {
  ...
  t.allowedHosts.includes(window.location.hostname) && Bo(n, t);
}
const va = ya, Aa = er;
export {
  la as Auth,
  Sa as FrameworkClient,
  tr as IndexedDBStorage,
  Ue as InstantAPIError,
  ha as InstantCoreDatabase,
  q as InstantError,
  Ao as InstantStream,
  ...
  fo as SSEConnection,
  da as Storage,
  Aa as StorageInterface,
  er as StoreInterface,
  fa as Streams,
  wo as SyncTableCallbackEventType,
  ne as TransactionValidationError,
  nr as WindowNetworkListener,
  br as coerceQuery,
  Ze as coerceToDate,
  wa as createInstantRouteHandler,
  Ta as getInfiniteQueryInitialSnapshot,
  ci as getOps,
  $ as i,
  j as id,
  ya as init,
  va as init_experimental,
  oi as lookup,
  _a as parseSchemaFromJSON,
  ga as setInstantWarningsEnabled,
  ma as tx,
  Yn as txInit,
  fn as validateQuery,
  lo as validateTransactions,
  or as version,
  L as weakHash
};
