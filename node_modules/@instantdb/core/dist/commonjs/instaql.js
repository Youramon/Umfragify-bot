...
const datalog_js_1 = require("./datalog.js");
const id_ts_1 = require("./utils/id.js");
const strings_ts_1 = require("./utils/strings.js");
const s = __importStar(require("./store.js"));
const warningToggle_ts_1 = require("./warningToggle.js");
let _seed = 0;
...
function compareDisparateValues(a, b, dataType) {
    if (dataType === 'string') {
        return (0, strings_ts_1.stringCompare)(a, b);
    }
    if (a > b) {
        return 1;
    }
...
function compareOrder(id_a, v_a, id_b, v_b, dataType) {
    if (v_a === v_b || (v_a == null && v_b == null)) {
        return (0, id_ts_1.uuidCompare)(id_a, id_b);
    }
    if (v_b == null) {
        return 1;
    }
...
function resolveObjects(store, attrsStore, { etype, level, form, join, pageInfo }) {
    ...
    if (limit != null) {
        if (level > 0 && warningToggle_ts_1.warningEnabled) {
